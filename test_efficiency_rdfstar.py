...
current = time.time()
g = Graph()
g.parse("test/test_rdfstar/efficiency-turtlestar/turtle-star-syntax-basic-01.ttl", format = "ttls")
...
size+=get_deep_size(g)
g = Graph()
g.parse("test/test_rdfstar/efficiency-turtlestar/turtle-star-eval-01.ttl", format = "ttls")
print(get_deep_size(g))
counter+=1
size+=get_deep_size(g)
g = Graph()
